...
import com.mohamedtaha.imagine.helper.util.PlaybackStatus;
...
//        seekBar.setOnSeekBarChangeListener(this);
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        if (DetailsSoundActivity.IS_OPEN) {
    ...
    private void stopMedia() {
        ...
        ListSoundReader.isServiceRunning = false;
        ...
        mediaSession.setCallback(new MediaSessionCompat.Callback() {
            ...
            public void onStop() {
                ...
                if (DetailsSoundActivity.IS_OPEN) {
                    ...
                    Intent intent = new Intent(DetailsSoundActivity.BROADCAST_FINISH_ACTIVITY);
    ...
    private void isNetworkConnected() {
        ...
        new Handler().postDelayed(() -> {
            ListSoundReader.ListSoundReaderLoadingIndicator.setVisibility(View.GONE);
            if (DetailsSoundActivity.isDetailsActivityTrue) {
                DetailsSoundActivity.DetailsSoundActivity_loading_indicator.setVisibility(View.GONE);
            }
            if ( exStore.exists()) {
