...
public class AdapterAzanVP extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        ConvertTimes.convertDateToFormatArabic(azan.getDate_today());
...
//        }
    ...
    private void setData(RecyclerAzanViewHolder recyclerAzanViewHolder, Timings azan) {
        recyclerAzanViewHolder.TVFagr.setText(ConvertTimes.convertTimeToAM(azan.getFajr().substring(0, 5)));
        recyclerAzanViewHolder.TVSunrise.setText(ConvertTimes.convertTimeToAM(azan.getSunrise().substring(0, 5)));
        recyclerAzanViewHolder.TVDauhr.setText(ConvertTimes.convertTimeToAM(azan.getDhuhr().substring(0, 5)));
        recyclerAzanViewHolder.TVAsr.setText(ConvertTimes.convertTimeToAM(azan.getAsr().substring(0, 5)));
        recyclerAzanViewHolder.TVMagrib.setText(ConvertTimes.convertTimeToAM(azan.getMaghrib().substring(0, 5)));
        recyclerAzanViewHolder.TVEsha.setText(ConvertTimes.convertTimeToAM(azan.getIsha().substring(0, 5)));
        recyclerAzanViewHolder.TVDateToday.setText(ConvertTimes.convertDateToFormatArabic(azan.getDate_today()));
        recyclerAzanViewHolder.TVCity.setText(azan.getCity());
        recyclerAzanViewHolder.TVDateTodayHegry.setText(ConvertTimes.convertDateToFormatArabicHegry(azan.getDay_today_hegry()));
    ...
    private void checkTimeForChangeColorTextView(RecyclerAzanViewHolder recyclerAzanViewHolder, Timings azan) {
        if (ConvertTimes.convertDate().equals(azan.getDate_today()) && ConvertTimes.compareTwoTimes(ConvertTimes.convertTimeToAM(azan.getFajr().substring(0, 5)))) {
        ...
        } else if (ConvertTimes.convertDate().equals(azan.getDate_today()) && ConvertTimes.compareTwoTimes(ConvertTimes.convertTimeToAM(azan.getSunrise().substring(0, 5)))) {
        ...
        } else if (ConvertTimes.convertDate().equals(azan.getDate_today()) && ConvertTimes.compareTwoTimes(ConvertTimes.convertTimeToAM(azan.getDhuhr().substring(0, 5)))) {
        ...
        } else if (ConvertTimes.convertDate().equals(azan.getDate_today()) && ConvertTimes.compareTwoTimes(ConvertTimes.convertTimeToAM(azan.getAsr().substring(0, 5)))) {
        ...
        } else if (ConvertTimes.convertDate().equals(azan.getDate_today()) && ConvertTimes.compareTwoTimes(ConvertTimes.convertTimeToAM(azan.getMaghrib().substring(0, 5)))) {
        ...
        } else if (ConvertTimes.convertDate().equals(azan.getDate_today()) && ConvertTimes.compareTwoTimes(ConvertTimes.convertTimeToAM(azan.getIsha().substring(0, 5)))) {
    ...
    private void showPrayerTimeForward(RecyclerAzanViewHolder recyclerAzanViewHolder, Timings azan) {
        ...
        if (ConvertTimes.convertDate().equals(azan.getDate_today())) {
    ...
    private void showTimer(TextView textView, String prayer_times) {
        show_timer_every_menutes = new CountDownTimer(20 * 60000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                textView.setText(ConvertTimes.compareTwoTimess(ConvertTimes.convertTimeToAM(prayer_times)));
            }
