...
public class Meta_______ {
    ...
    public Method_______ getMethod() {
        return method;
    }

    public void setMethod(Method_______ method) {
        this.method = method;
    }
    ...
    public Offset_______ getOffset() {
        return offset;
    }

    public void setOffset(Offset_______ offset) {
        this.offset = offset;
    }
