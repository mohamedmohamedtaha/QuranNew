...
public class Meta________ {
    ...
    public Method________ getMethod() {
        return method;
    }

    public void setMethod(Method________ method) {
        this.method = method;
    }
    ...
    public Offset________ getOffset() {
        return offset;
    }

    public void setOffset(Offset________ offset) {
        this.offset = offset;
    }
