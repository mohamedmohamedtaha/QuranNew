...
//                Integer.valueOf(prayer_times.getIsha().substring(3, 5)), context.getString(R.string.isha_string));
        ...
        setTimePrayerWithText(Integer.valueOf("22"),
                Integer.valueOf("22"),  context.getString(R.string.fagr_string));
        setTimePrayerWithText( Integer.valueOf("22"),
                Integer.valueOf("23"), context.getString(R.string.sunrise_string));
        setTimePrayerWithText(Integer.valueOf("22"),
                Integer.valueOf("24"), context.getString(R.string.duhr_string));
        setTimePrayerWithText( Integer.valueOf("22"),
                Integer.valueOf("25"), context.getString(R.string.asr_string));
        setTimePrayerWithText( Integer.valueOf("22"),
                Integer.valueOf("26"), context.getString(R.string.magrib_string));
        setTimePrayerWithText( Integer.valueOf("22"),
                Integer.valueOf("27"), context.getString(R.string.isha_string));
