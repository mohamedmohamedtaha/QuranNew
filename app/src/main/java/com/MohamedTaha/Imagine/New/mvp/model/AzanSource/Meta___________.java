...
public class Meta___________ {
    ...
    @Expose
    private Method___________ method;
    ...
    @Expose
    private Offset___________ offset;
    ...
    public Method___________ getMethod() {
        return method;
    }

    public void setMethod(Method___________ method) {
        this.method = method;
    }
    ...
    public Offset___________ getOffset() {
        return offset;
    }

    public void setOffset(Offset___________ offset) {
        this.offset = offset;
    }
