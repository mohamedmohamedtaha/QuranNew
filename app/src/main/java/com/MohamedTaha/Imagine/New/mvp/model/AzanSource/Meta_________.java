...
public class Meta_________ {
    ...
    @Expose
    private Method_________ method;
    ...
    @Expose
    private Offset_________ offset;
    ...
    public Method_________ getMethod() {
        return method;
    }

    public void setMethod(Method_________ method) {
        this.method = method;
    }
    ...
    public Offset_________ getOffset() {
        return offset;
    }

    public void setOffset(Offset_________ offset) {
        this.offset = offset;
    }
