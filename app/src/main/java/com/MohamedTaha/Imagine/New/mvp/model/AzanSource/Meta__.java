...
public class Meta__ {
    ...
    public Method__ getMethod() {
        return method;
    }

    public void setMethod(Method__ method) {
        this.method = method;
    }
    ...
    public Offset__ getOffset() {
        return offset;
    }

    public void setOffset(Offset__ offset) {
        this.offset = offset;
    }
