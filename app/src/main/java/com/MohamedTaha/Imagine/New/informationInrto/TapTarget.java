package com.MohamedTaha.Imagine.New.informationInrto;
...
public class TapTarget {
    ...
    @ColorRes
    protected int outerCircleColorRes = -1;
    @ColorRes
    protected int targetCircleColorRes = -1;
    @ColorRes
    protected int dimColorRes = -1;
    @ColorRes
    protected int titleTextColorRes = -1;
    @ColorRes
    protected int descriptionTextColorRes = -1;

    protected Integer outerCircleColor = null;
    protected Integer targetCircleColor = null;
    protected Integer dimColor = null;
    protected Integer titleTextColor = null;
    protected Integer descriptionTextColor = null;

    @DimenRes
    protected int titleTextDimen = -1;
    @DimenRes
    protected int descriptionTextDimen = -1;

    protected int titleTextSize = 20;
    protected int descriptionTextSize = 18;
    int id = -1;
    ...
    @Nullable
    protected Integer colorResOrInt(Context context, @Nullable Integer value, @ColorRes int resource) {
        if (resource != -1) {
    ...
    protected int dimenOrSize(Context context, int size, @DimenRes int dimen) {
        if (dimen != -1) {
