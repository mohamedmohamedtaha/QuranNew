...
public class Meta__________ {
    ...
    @Expose
    private Method__________ method;
    ...
    @Expose
    private Offset__________ offset;
    ...
    public Method__________ getMethod() {
        return method;
    }

    public void setMethod(Method__________ method) {
        this.method = method;
    }
    ...
    public Offset__________ getOffset() {
        return offset;
    }

    public void setOffset(Offset__________ offset) {
        this.offset = offset;
    }
